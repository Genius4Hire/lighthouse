...
var flavInStock = false; 
var vesselInStock = false;
var toppingInStock = false;

if ((flavor === 'vanilla') || (flavor === 'chocolate')) {flavInStock = true}
if ((vessel === 'cone') || (vessel === 'bowl')) {vesselInStock = true}
if ((toppings === 'sprinkles') || (toppings === 'peanuts')) {toppingInStock = true}
if (flavInStock && vesselInStock && toppingInStock) {
